...
public class CreateTableRunner extends QueryRunner<ParsedCreateTable> {
	...
	@Override
	public void run(ParsedCreateTable parsed, boolean log) {
		...
		Table t = new Table(parsed.getTableName(), fields, primaryKeyField, null);
		t.setView(new View(t, null, t.getName(), null));
